...
HD_PWD='C:/Users/ohho9/Desktop/ECE524/project/csun_ece524_pipelined_cpu/project_ece524_pipelined_cpu/project_ece524_pipelined_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalPipelineCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FinalPipelineCPU.tcl
